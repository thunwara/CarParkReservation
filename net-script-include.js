var carParkingTimeAjax = Class.create();
carParkingTimeAjax.prototype =
Object.extendsObject(AbstractAjaxProcessor, {
    ...
    var startDateSplit = startDateTime.split(" ");
    var endDateSplit = endDateTime.split(" ");

    //Query Record
    var carRecord = new GlideRecord('sc_req_item');

    //Query SELECT carID is carRID
    carRecord.addEncodedQuery("active=true^variables.a0c57d8a47262110b6bcf2e7536d4317="+carRID);
